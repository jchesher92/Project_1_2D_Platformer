...
void render_init_shaders(Render_State_Internal *state) {
    state->shader_default = render_shader_create (
        "/home/james/Development/opengl_projects/2d_platformer1/engine_from_scratch/shaders/default.vert",
        "/home/james/Development/opengl_projects/2d_platformer1/engine_from_scratch/shaders/default.frag"
    );
